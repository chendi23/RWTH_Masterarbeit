...
def get_searched_arch(searched_with='spc'):
    if searched_with == 'spc':
        backbone = [1, 1, 1, 1, 1, 1, 2, 3, 2, 3, 3, 3]
        cell_arch = np.array([[1, 3],
                              [0, 3],
                              [0, 3],
                              [1, 3],
                              [0, 3],
                              ...
                              [0, 3],
                              [2, 4]])
        cell_arch = cell_arch.astype('uint8')
        cell_arch = cell_arch.tolist()

    elif searched_with == 'ce':
        backbone = [1, 1, 2, 3, 2, 3, 3, 2, 3, 3, 3, 2]
        cell_arch = np.array([[0, 3],
                              [1, 3],
                              [1, 4],
                              [0, 3],
                              [2, 3],
    ...
    elif searched_with == 'focal':
        backbone = np.array([1, 1, 1, 0, 1, 2, 1, 2, 1, 2, 2, 3])
        cell_arch = np.array([[0, 3],
                              [1, 3],
                              [2, 3],
                              [1, 3],
    ...
    elif searched_with == 'focal_spc':
        backbone = np.array([1, 1, 2, 1, 0, 1, 1, 2, 1, 2, 2, 3])
        cell_arch = np.array([[0, 3],
                              [1, 3],
                              [0, 3],
                              [1, 3],
        ...
        raise ValueError('the model must be searched with ce/spc/focal/focal_spc')
    return backbone, cell_arch
