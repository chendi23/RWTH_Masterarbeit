...
OUTPUT_PATH=${TRAIN_CODE_PATH}/OUTPUTS_769_s_focal_r_focal
...
/work/scratch/chendi/anaconda3/envs/py3.8/bin/python "${TRAIN_CODE_PATH}"/train.py --out_path="${OUTPUT_PATH}"/ckpt --data_path="${DATASET_PATH}" --modelArts=False --parallel=False --searched_with=focal --criterion=focal --batch_size=4 --crop_size=769 --start_epoch=800 --ckpt_name=/home/students/chendi/projects/Auto-DeepLab-main/OUTPUTS_769_s_focal_r_focal/ckpt/device/autodeeplab-paral_8-50_743.ckpt --epochs="${EPOCHS}" >>log_s_focal_r_focal_bs4.txt 2>&1
