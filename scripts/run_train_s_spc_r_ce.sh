...
OUTPUT_PATH=${TRAIN_CODE_PATH}/OUTPUTS_769_s_spc_r_ce
...
/work/scratch/chendi/anaconda3/envs/py3.8/bin/python "${TRAIN_CODE_PATH}"/train.py --out_path="${OUTPUT_PATH}"/ckpt --data_path="${DATASET_PATH}" --modelArts=False --parallel=False --searched_with=spc --batch_size=8 --ckpt_name /home/students/chendi/projects/Auto-DeepLab-main/OUTPUTS_769_s_spc_r_ce/ckpt/device/autodeeplab-paral_18-600_371.ckpt --affine=False --start_epoch=1200 --epochs="${EPOCHS}" >>log_s_spc_r_ce_bs6.txt 2>&1
