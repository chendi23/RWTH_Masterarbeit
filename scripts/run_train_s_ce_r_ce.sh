...
/work/scratch/chendi/anaconda3/envs/py3.8/bin/python "${TRAIN_CODE_PATH}"/train.py --out_path="${OUTPUT_PATH}"/ckpt --data_path="${DATASET_PATH}" --modelArts=False --parallel=False --searched_with=ce --batch_size=8 --ckpt_name /home/students/chendi/projects/Auto-DeepLab-main/OUTPUTS_769_s_ce_r_ce/ckpt/device/autodeeplab-paral_8-875_371.ckpt --affine=False --start_epoch=1150 --epochs="${EPOCHS}" >>log_s_ce_r_ce_bs6.txt 2>&1
