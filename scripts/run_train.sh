...
OUTPUT_PATH=${TRAIN_CODE_PATH}/OUTPUTS_769_default
...
/work/scratch/chendi/anaconda3/envs/py3.8/bin/python "${TRAIN_CODE_PATH}"/train.py --out_path="${OUTPUT_PATH}"/ckpt --data_path="${DATASET_PATH}" --modelArts=False --parallel=False --batch_size=8 --ckpt_name /home/students/chendi/projects/Auto-DeepLab-main/OUTPUTS_769_default/ckpt/device/autodeeplab-paral_9-100_495.ckpt --start_epoch 525 --affine=False --epochs="${EPOCHS}"  >>log_bs6.txt 2>&1
